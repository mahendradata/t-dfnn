...
#
# Running example: "python3 dfnn-batch.py conf/dfnn-batch.json 1 2 3"
# --------------------------------------------------------------
...
def training(model: DFNN, x, y, name: str, batch: Dict, data_dir: str) -> DFNN:
...
def experiment(exp_id: str):
    ...
    for num, batch in enumerate(CONF.batch):
        ...
        name = "DFNNs-batch.{}".format(num)  # Model name and batch number
        ...
        # Training
        model = training(model, train_x, train_y, name, batch, data_dir)
